...
async function sendToken(body: userToken) {
  return await EmployeeRepository.setToken(body.email, body.deviceToken)
}

export const EmployeeService = { signIn, getAllEmployees, sendToken };
